...
import { auth, handleInputChange, handleKeyDown } from './Signup';
    ...
    <div className="content">
      <div className="form">
        ...
        <input type="password" name="password" placeholder="Password" className="form-control"
          onChange={e => handleInputChange(setPassword, e)} onKeyDown={e => handleKeyDown('emptyEmail', username, password, setRedirect, 'login', e)} />
