    ...
    <div className="content">
      <div className="form">
        ...
        <div className="input-box">
          ...
          <span>Username contains at least 4 characters, which can be letters, digits and underscore.</span>
        </div>
        <div className="input-box">
          <input type="password" name="password" placeholder="Password" className="form-control"
            onChange={(e) => handleInputChange(setPassword, e)} />
          <span>Password contains at least 8 characters, including a uppercase letter, a lowercase letter,
